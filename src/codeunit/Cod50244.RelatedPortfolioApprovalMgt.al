codeunit 50244 "Related Portfolio Approval Mgt"
{
    trigger OnRun()
    begin
    ...
    begin
        RecRef.Open(Database::"Portfolio RelatedParty");
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONSENDFORAPPROVALCODE, RecRef), Database::"Portfolio RelatedParty",
          GetWorkflowEventDesc(WorkflowSendForApprovalEventDescTxt, RecRef), 0, false);
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONCANCELFORAPPROVALCODE, RecRef), Database::"Portfolio RelatedParty",
          GetWorkflowEventDesc(WorkflowCancelForApprovalEventDescTxt, RecRef), 0, false);
    end;
    // subscribe

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Related Portfolio Approval Mgt", 'OnSendWorkflowForApproval', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Related Portfolio Approval Mgt", 'OnCancelWorkflowForApproval', '', false, false)]
    ...
    var
        CustomWorkflowHdr: Record "Portfolio RelatedParty";
    begin
        case RecRef.Number of
            Database::"Portfolio RelatedParty":
                begin
