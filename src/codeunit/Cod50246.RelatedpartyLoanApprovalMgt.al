codeunit 50246 "Relatedparty Loan Approval Mgt"
{
    trigger OnRun()
    begin
    ...
    begin
        RecRef.Open(Database::"RelatedParty Loan");
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONSENDFORAPPROVALCODE, RecRef), Database::"RelatedParty Loan",
          GetWorkflowEventDesc(WorkflowSendForApprovalEventDescTxt, RecRef), 0, false);
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONCANCELFORAPPROVALCODE, RecRef), DATABASE::"RelatedParty Loan",
          GetWorkflowEventDesc(WorkflowCancelForApprovalEventDescTxt, RecRef), 0, false);
        WorkflowEventHandling.AddEventToLibrary(GetWorkflowCode(RUNWORKFLOWONREOPENFORAPPROVALCODE, RecRef), DATABASE::"RelatedParty Loan",
        GetWorkflowEventDesc(WorkflowReopenForApprovalEventDescTxt, RecRef), 0, false);
    end;
    // subscribe

    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Relatedparty Loan Approval Mgt", 'OnSendWorkflowForApproval', '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Relatedparty Loan Approval Mgt", OnCancelWorkflowForApproval, '', false, false)]
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Relatedparty Loan Approval Mgt", OnReopenWorkflowForApproval, '', false, false)]
    ...
    var
        CustomWorkflowHdr: Record "RelatedParty Loan";
    begin
        case RecRef.Number of
            Database::"RelatedParty Loan":
                begin
