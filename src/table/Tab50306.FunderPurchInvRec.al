table 50306 "Funder Purch. Inv Rec."
{
    ...
    fields
    {
        ...
        field(3; "Funder Loan No"; Code[50])
        {
            DataClassification = ToBeClassified;
            ...
            begin
                _funderLoan.Reset();
                _funderLoan.SetRange("No.", "Funder Loan No");
                if _funderLoan.Find('-') then
                    "Funder Loan Name" := _funderLoan.Name;

                _funder.Reset();
                _funder.SetRange("No.", _funderLoan."Funder No.");
                if _funder.Find('-') then
                    "Shortcut Dimension 1 Code" := _funder."Shortcut Dimension 1 Code";
            end;
        }
        field(5; "Funder Loan Name"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(50; "Funder"; Code[20])
        {
            ...
            begin
                ...
                "Vendor No." := _icPartner."Vendor No."
            end;
        }
