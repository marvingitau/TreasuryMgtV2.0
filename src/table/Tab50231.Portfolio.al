table 50231 Portfolio
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ","Bank Loan",Institutional,Individual,"Asset Term Manager","Medium Term Notes","Bank Overdraft","Relatedparty";
        ...
        field(5000; Status; Enum PortfolioStatus)
        {
            ...
            begin
                ...
                if porfolioRec.Find('-') then begin
                    ...
                    trsyDocSetup.SetRange(trsyDocSetup."Must Attached", true);
                    trsyDocSetup.SetFilter(trsyDocSetup."Document No.", '<>%1', '');
