report 50280 "Related Rem. on Plac. Mature"
{
    ...
    dataset
    {
        dataitem("RelatedParty Loan"; "RelatedParty Loan")
        {
            ...
            begin
                GeneralSetup.Get(0);
                "RelatedParty Loan".SetRange(Status, "RelatedParty Loan".Status::Approved);
                "RelatedParty Loan".SetFilter("RelatedParty Loan".MaturityDate, '<>%1', 0D);
            end;
            ...
            begin
                ...
                */
                if true then begin // (20290430D - "RelatedParty Loan".MaturityDate) = GeneralSetup."Placemnt. Matur Rem. Time"

                    // RelatedPartyLoanTbl.Reset();
                    // RelatedPartyLoanTbl.SetRange("No.", FunderNo);
                    // if not RelatedPartyLoanTbl.Find('-') then
                    //     Error('RelatedParty Loan not %1 found', FunderNo);
                    ...
                    */
                    ...
                    EmailingCU.SendReminderOnPlacementMaturityRelatedParty("RelatedParty Loan"."No.");
                    ...
                    _remOnPlacementMature.Category := "RelatedParty Loan".Category;
                    _remOnPlacementMature.DueDate := "RelatedParty Loan".MaturityDate;
    ...
    trigger OnPreReport()
    var
        _filter, _loanNo : Text;
    begin
        _filter := "RelatedParty Loan".GetFilters();
        _loanNo := "RelatedParty Loan".GetFilter("No.");
    end;

    trigger OnPostReport()
    begin
        EmailingCU.SendReminderOnPlacementMaturityStaffRelatedParty();
    end;
