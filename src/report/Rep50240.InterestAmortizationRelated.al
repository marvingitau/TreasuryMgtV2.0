report 50240 "Interest Amortization Related"
{
    ...
    var
        ...
        DueDateCalcPeriodEq, _secondStep : Boolean;

        dueDate, _previousMonthInLoop, StatingQuarterStartDate, _previousQuarterInLoop, _previousBiannInLoop, StatingBiannStartDate, _previousAnnualInLoop : Date;
    ...
    begin
        ...
        dueDate := RelatedPartyTbl.FirstDueDate;
        ...
        _dueDateInfluence := RelatedPartyTbl.EnableDynamicPeriod;
        _skipWeekendInfluence := RelatedPartyTbl.EnableWeekDayReporting;
        ...
        if RelatedPartyTbl.PeriodicPaymentOfInterest = RelatedPartyTbl.PeriodicPaymentOfInterest::Monthly then begin
        ...
        if RelatedPartyTbl.PeriodicPaymentOfInterest = RelatedPartyTbl.PeriodicPaymentOfInterest::Quarterly then begin
        ...
        if RelatedPartyTbl.PeriodicPaymentOfInterest = RelatedPartyTbl.PeriodicPaymentOfInterest::Biannually then begin
            ...
            if ((_dueDateInfluence = true) and (_skipWeekendInfluence = true)) then begin
                ...
                for BiannCounter := 0 to NoOfBiann do begin
                    ...
                    end else if RelatedPartyTbl.InterestMethod = RelatedPartyTbl.InterestMethod::"30/365" then begin
                        monthlyInterest := ((_interestRate_Active / 100) * _principle) * (30 / 365);
                    end
                    else if RelatedPartyTbl.InterestMethod = RelatedPartyTbl.InterestMethod::"30/365" then begin
                        monthlyInterest := ((_interestRate_Active / 100) * _principle) * (30 / 365);
        ...
        if RelatedPartyTbl.PeriodicPaymentOfInterest = RelatedPartyTbl.PeriodicPaymentOfInterest::Annually then begin
            if ((_dueDateInfluence = true) and (_skipWeekendInfluence = true)) then begin
            ...
            */
            if ((_dueDateInfluence = false) and (_skipWeekendInfluence = false)) then begin
                ...
                for AnnualCounter := 0 to NoOfAnnual do begin
                    ...
                    //     _currentAnnualInLoop := GetEndOfYear(placementDate);
                    //     if RelatedPartyTbl."Inclusive Counting Interest" = true then
                    //         DaysInAnnual := _currentAnnualInLoop - placementDate + 1
                    //     else
                    //         DaysInAnnual := _currentAnnualInLoop - placementDate
                    // end
